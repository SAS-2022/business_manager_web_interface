...
/// Dropped the subscription paywall entirely (crown/golden-lock badges,
/// `PremiumAccessSheet`, `subscriptionScreen` navigation) — same rationale
/// as the main Settings menu (Stage 12) and every other paywalled surface
/// in this port: web has no subscribe flow, so every row now navigates
/// straight through to its (stub, for now) destination screen instead of
/// dead-ending on a paywall. Also dropped the unused `ProductService ps`,
/// `WarningDialog warningDialog`, and `getPackageInfo` fields — none were
/// referenced anywhere in mobile's own real code for this screen.
